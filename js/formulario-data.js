...
const FORMULARIO = [
  ...
  },
  {
    ...
    formulas: [
      ...
      { name: 'Volume cubo', expr: 'V = l³', shape: 'cube', note: 'l = lunghezza dello spigolo' },
      { name: 'Volume parallelepipedo', expr: 'V = l × w × h', shape: 'box', note: 'l = lunghezza, w = larghezza, h = altezza' },
      { name: 'Volume cilindro', expr: 'V = πr²h', shape: 'cylinder', note: 'r = raggio di base, h = altezza' },
      { name: 'Volume sfera', expr: 'V = (4/3)πr³', shape: 'sphere', note: 'r = raggio della sfera' },
      { name: 'Volume cono', expr: 'V = (1/3)πr²h', shape: 'cone', note: 'r = raggio di base, h = altezza' },
    ],
  },
  {
    key: 'trigonometria',
